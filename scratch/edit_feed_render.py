filepath = r"c:\Users\campw\Desktop\Vanlyfa-Stable1\Vanlyfa-main - Copy\components\feed.js"
with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

target_start = "function renderSocialFeed(containerId, isSidebar = false) {"
target_end = """  container.innerHTML = feedHtml;
...
if start_idx == -1 or end_idx == -1:
    print("Error: renderSocialFeed boundaries not found in components/feed.js")
    exit(1)

end_idx += len(target_end)

replacement = """function renderSocialFeed(containerId, isSidebar = false) {
            ...
            return `
              <div class="thread-reply-item" style="display:flex; gap:8px; align-items:flex-start; font-size:12px;">
                ...
                <div class="reply-content-box" style="background:var(--bg-sand); padding:6px 10px; border-radius:var(--radius-sm); flex-grow:1; text-align:left;">
                  ...
                  <p class="reply-text" style="color:var(--text-main); margin:0; line-height:1.3;">${c.text}</p>
                </div>
              </div>
            `;
          }).join('')}
        ...
        <div class="thread-post-layout" style="display:flex; gap:12px;">
          ...
          <div class="thread-right-col" style="flex-grow:1; text-align:left;">
            ...
            <div class="thread-body" style="margin-top:6px;">
              <p class="thread-content" style="margin:0; font-size:13px; line-height:1.5; color:var(--text-main); white-space: pre-wrap;">${post.content}</p>
              ${imgMarkup}
            </div>
...
print("components/feed.js renderSocialFeed updated successfully!")
